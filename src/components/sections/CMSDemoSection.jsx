...
export default function CMSDemoSection() {
  ...
  return (
    <div className="relative" dir={isRTL ? "rtl" : "ltr"}>
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-background via-primary/5 to-background pt-32 pb-32">
        ...
        <div className="relative max-w-7xl mx-auto px-6 text-center z-10">
          ...
          <p
            className="text-xl md:text-2xl text-foreground max-w-4xl mx-auto leading-relaxed mb-12"
      ...
      {/* Final CTA */}
      <section className="py-32 px-6 bg-primary text-primary-foreground relative z-10">
